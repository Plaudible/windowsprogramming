...
namespace Canvas_ObsCollection_Project
{
    public partial class Model : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<MyShape> CircCollection;
        ...
        public void InitModel(UInt32 height, UInt32 width)
        {
            ...
            CircCollection = new ObservableCollection<MyShape>();
            ResetRectangles();
        }
        ...
        private UInt32 _numShapes = 100;
        public UInt32 NumShapes
        {
            get { return _numShapes; }
            set
            {
                _numShapes = value;
                OnPropertyChanged("NumShapes");
            }
        }
 
        private void SetRandomRects(MyShape shape)
        {
        ...
        private void SetRandomCircs(MyShape shape)
        {
        ...
        public void ResetRectangles()
        {
            ...
            CircCollection.Clear();

            for (int rects = 0; rects < _numShapes; rects++)
            {
                MyShape temp = new MyShape();
                SetRandomRects(temp);
                RectCollection.Add(temp);
                MyShape temp2 = new MyShape();
                SetRandomCircs(temp2);
                CircCollection.Add(temp2);
            }
        }
